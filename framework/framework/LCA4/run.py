...
def display_result():
	...
	if request.method == 'POST':
		...
		if not resp: #no error occurred
			return render_template('result_page.html', graphdata=graphdata[0], graphdata2 = graphdata[1], graphdata3 = graphdata[2], graphdata4 = graphdata[3], graphdata5 = graphdata[4], graphdata6 = graphdata[5], graphdata7 = graphdata[6])
		else:
			return redirect(url_for('upload_file'))
